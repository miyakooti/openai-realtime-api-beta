...
export class RealtimeClient extends RealtimeEventHandler {
   ...
   */
  constructor({ url, apiKey="svcacct-xSTMUSEKVcE9z5ppziDALxNkN4jMHhwtPgt7tvoxuguqVBFlY-9XjT0YvP-56hVtcAOuaaT3BlbkFJbpYqZx0DBOP1KID4jvx_JhDaVgugd9SPBPV8wvuQaeL2p80gHEmDkjwjW_tbUYmKVPWs8A", dangerouslyAllowAPIKeyInBrowser, debug } = {}) {
    super();
    ...
    this.realtime = new RealtimeAPI({
      url,
      apiKey: "svcacct-xSTMUSEKVcE9z5ppziDALxNkN4jMHhwtPgt7tvoxuguqVBFlY-9XjT0YvP-56hVtcAOuaaT3BlbkFJbpYqZx0DBOP1KID4jvx_JhDaVgugd9SPBPV8wvuQaeL2p80gHEmDkjwjW_tbUYmKVPWs8A",
